...
1.  Instantiate a *ModifyTerrain* object:\
    ...
    `feature_ids` is a list of [features shortnames](https://github.com/RiverArchitect/Welcome/wiki/River-design-features#introduction-and-feature-groups)\
